...
{
    public class JobOfferInternalDto
    {
        ...
        public List<JobPregradoInternaDto> JobPregradoList { get; set; }
        public List<JobPostgradoInternaDto> JobPostgradoList { get; set; }
        public JobOfferInternalDto()
        {
            JobIdiomList = new List<JobIdiomDto>();
            JobKeyWordList = new List<JobKeyWordDto>();
            JobPregradoList = new List<JobPregradoInternaDto>();
            JobPostgradoList = new List<JobPostgradoInternaDto>();
        }
    }
}
