...
{
    public class ReinitCampaignCommand : IRequest<Result>
    {
        public int IdCampaign { get; set; }
    }

    public class ReinitCampaignCommandHandler : IRequestHandler<ReinitCampaignCommand, Result>
    {
        ...
        public ReinitCampaignCommandHandler(IBaseRepository<Domain.Campaign.Models.Campaign> baseCampaign, IOptions<AppSettings> appSettings, IUnitOfWork unitOfWork, IEvaluationRepository evaluationRepository, IBaseRepository<Domain.Evaluation.Models.EvaluationDetail> baseEvDetail, IBaseRepository<Domain.Evaluation.Models.Evaluation> baseEv)
        {
        ...
        public async Task<Result> Handle(ReinitCampaignCommand request, CancellationToken cancellationToken)
        {
            ...
            if (header != null)
            {
                ...
                foreach(var item in header)
                {
                    ...
                    currentCampaign.IsResetT0 = true;
