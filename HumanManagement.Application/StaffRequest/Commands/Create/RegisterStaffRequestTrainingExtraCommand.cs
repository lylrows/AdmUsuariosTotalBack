...
{
    public  class RegisterStaffRequestTrainingExtraCommand : IRequest<Result>
    {
        public RegisterCapacitacionExtraDto payload { get; set; }
    }
    public class RegisterStaffRequestTrainingExtraCommandHandler : IRequestHandler<RegisterStaffRequestTrainingExtraCommand, Result>
    {
        ...
        public RegisterStaffRequestTrainingExtraCommandHandler(IBaseRepository<StaffRequestModel> baseStaffRequestRepository,
        ...
        public async Task<Result> Handle(RegisterStaffRequestTrainingExtraCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _staffRequestRepository.RegisterRequestCapacitacionExtra(request.payload);
