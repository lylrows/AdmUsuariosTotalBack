...
{
    public class CreateStaffRequestBurialCommand : IRequest<Result>
    {
        public RegisterRequestBurial payload { get;set; }
    }

    public class CreateStaffRequestBurialCommanddHandler : IRequestHandler<CreateStaffRequestBurialCommand, Result>
    {
        ...
        public CreateStaffRequestBurialCommanddHandler(IBaseRepository<StaffRequestModel> baseStaffRequestRepository,
        ...
        public async Task<Result> Handle(CreateStaffRequestBurialCommand request, CancellationToken cancellationToken)
        {
            try 
            {
                ...
                await _staffRequestRepository.RegisterRequestBurial(request.payload);
