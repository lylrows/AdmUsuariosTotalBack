...
{
    public class RegisterStaffSureCommand : IRequest<Result>
    {
        public RegisterRequestSure payload { get; set; }
        public IFormFile file { get; set; } 
    }

    public class RegisterStaffSureCommandHandler : IRequestHandler<RegisterStaffSureCommand, Result>
    {
        ...
        public RegisterStaffSureCommandHandler(IBaseRepository<StaffRequestModel> baseStaffRequestRepository,
        ...
        public async Task<Result> Handle(RegisterStaffSureCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _staffRequestRepository.RegisterRequestSure(request.payload, request.file);
                ...
                var typeSoli = request.payload.Isaffiliate == true ? "Afiliacion" : "Desafiliacion";
                ...
                foreach (var item in list)
                {
                    ...
                    newNotification.Subject = "Solicitud de " + typeSoli + ' ' + "de Seguros";
