...
{
    public class ApprovedTypeSureCommand : IRequest<Result>
    {
        public ApprovedSalaryDto payload { get; set; }
    }

    public class ApprovedTypeSureCommandHandler : IRequestHandler<ApprovedTypeSureCommand, Result>
    {
        ...
        public ApprovedTypeSureCommandHandler(IBaseRepository<Domain.Notification.Model.NotificationModel> basenotify,
        ...
        public async Task<Result> Handle(ApprovedTypeSureCommand request, CancellationToken cancellationToken)
        {
            ...
            if (approver != null)
            {
                ...
                await _staffRequestRepository.ApprovedTypeSure(request.payload, false);
            ...
            {
                await _staffRequestRepository.ApprovedTypeSure(request.payload, true);
