...
{
    public class CreateStaffRequestMedicalCommand : IRequest<Result>
    {
        public RegisterRequestMedical payload { get; set; }
        public IFormFile file;
    }

    public class CreateStaffRequestMedicalCommandHandler : IRequestHandler<CreateStaffRequestMedicalCommand, Result>
    {
        ...
        public CreateStaffRequestMedicalCommandHandler(IBaseRepository<StaffRequestModel> baseStaffRequestRepository,
        ...
        public async Task<Result> Handle(CreateStaffRequestMedicalCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _staffRequestRepository.RegisterRequestMedical(request.payload, request.file);
                ...
                foreach (var item in list)
                {
                    ...
                    string fmt = File.ReadAllText(_appSettings.RegisterRequestMedical);
