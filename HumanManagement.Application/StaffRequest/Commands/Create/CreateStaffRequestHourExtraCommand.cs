...
{
    public class CreateStaffRequestHourExtraCommand : IRequest<Result>
    {
        public RegisterHourExtraDto payload { get; set; }
        public IFormFile file { get; set; }
    }

    public class CreateStaffRequestHourExtraCommandHandler : IRequestHandler<CreateStaffRequestHourExtraCommand, Result>
    {
        ...
        public CreateStaffRequestHourExtraCommandHandler(IBaseRepository<StaffRequestModel> baseStaffRequestRepository,
        ...
        public async Task<Result> Handle(CreateStaffRequestHourExtraCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _staffRequestRepository.RegisterRequestHourExtra(request.payload, request.file);
