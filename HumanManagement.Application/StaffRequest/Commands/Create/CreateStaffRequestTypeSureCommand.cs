...
{
    public class CreateStaffRequestTypeSureCommand : IRequest<Result>
    {
        public RegisterChangeSureDto payload { get; set; }
        public IFormFile file { get; set; } 
    }

    public class CreateStaffRequestTypeSureCommandHandler : IRequestHandler<CreateStaffRequestTypeSureCommand, Result>
    {
        ...
        public CreateStaffRequestTypeSureCommandHandler(IBaseRepository<StaffRequestModel> baseStaffRequestRepository,
        ...
        public async Task<Result> Handle(CreateStaffRequestTypeSureCommand request, CancellationToken cancellationToken)
        {
            try
            {
                ...
                await _staffRequestRepository.RegisterRequestTypeSure(request.payload, request.file);
                ...
                foreach (var item in list)
                {
                    ...
                    string fmt = File.ReadAllText(_appSettings.RegisterRequestTypeSure);
