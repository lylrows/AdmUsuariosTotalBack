...
{
    public class StaffRequestTrainingExtraGeneratePdf : IRequest<Result>
    {
        public int Id { get; set; }
    }

    public class StaffRequestTrainingExtraGeneratePdfHandler : IRequestHandler<StaffRequestTrainingExtraGeneratePdf, Result>
    {
        ...
        public StaffRequestTrainingExtraGeneratePdfHandler(
        ...
        public async Task<Result> Handle(StaffRequestTrainingExtraGeneratePdf request, CancellationToken cancellationToken)
        {
            var staffRequestAbsence = await staffRequestRepository.GetRequestCapacitacionExtraById(request.Id);
            ...
            var replaceTextAbsence = new ReplaceTextTrainingExtrGeneratePdf(staffRequestAbsence);
            replaceTextAbsence.Replace();
            var generatorVacationPdf = new GeneratorPdf(staffRequestAbsence.nid_request,
                                                                staffRequestDocument.SolicitudCapacitacionExtra,
