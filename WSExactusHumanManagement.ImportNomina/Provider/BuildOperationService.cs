...
using WSHumanManagement.Application.Exactus.Nomina.Services;

namespace WSExactusHumanManagement.ImportNomina.Provider
{
    ...
    public static class BuildOperationService
    {
        ...
        public static IServiceCollection ConfigureDI(this IServiceCollection services, string conexionSql)
        {
            ...
            services.AddScoped<IExactusNominaService, ExactusNominaService>();
            services.AddScoped<IEmpresaRepository, EmpresaRepository>();
            services.AddScoped<IExactusNominaRepository, ExactusNominaRepository>();
            services.AddScoped<IBaseRepository<SalaryConcept>, BaseRepository<SalaryConcept>>();
            services.AddScoped<IBaseRepository<SalaryPayrollDet>, BaseRepository<SalaryPayrollDet>>();

            services.AddScoped<IExactusNominaCabRepository, ExactusNominaCabRepository>();
            services.AddScoped<IBaseRepository<SalaryPayrollCab>, BaseRepository<SalaryPayrollCab>>();
